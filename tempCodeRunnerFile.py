...
panel1_label = tk.Label(panel1, text="Registered Driver", bg='#E67E22', fg='white', font=("Arial", 16), image=register_driver_icon, compound=tk.LEFT)
panel1_label.pack(expand=True)

panel2_label = tk.Label(panel2, text="Last month registered", bg='#E74C3C', fg='white', font=("Arial", 16), image=last_month_register_icon, compound=tk.LEFT)
panel2_label.pack(expand=True)

panel3_label = tk.Label(panel3, text="Last year registered", bg='#1ABC9C', fg='white', font=("Arial", 16), image=last_year_register_icon, compound=tk.LEFT)
panel3_label.pack(expand=True)
